...
module.exports = (dependecies) => {
  ...
  const addNewStudent = (req, res, next) => {
    ...
    // call use case
    AddStudentCommand.Execute(firstName, lastName, email)
      .then(
        (response) => {
          res.json(response);
        },
  ...
  const getStudent = (req, res, next) => {
    ...
    GetStudentQuery.Execute(req.params.studentId)
      .then(
        (student) => {
          res.json(student);
        },
  ...
  const addEnrollment = (req, res, next) => {
    ...
    AddEnrollmentCommand.Execute(req.params.studentId, req.body)
      .then(
        (response) => {
          res.json(response);
        },
